...
--
-- Table structure for table `recurrentes_done_table`
--

DROP TABLE IF EXISTS `recurrentes_done_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recurrentes_done_table` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `recurrente_id` int(11) NOT NULL,
  `done_recurrente` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `createdAt` timestamp NULL DEFAULT NULL,
  `updatedAt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `recurrentes_done_table`
--

LOCK TABLES `recurrentes_done_table` WRITE;
/*!40000 ALTER TABLE `recurrentes_done_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `recurrentes_done_table` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `recurrentes_table`
--

DROP TABLE IF EXISTS `recurrentes_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recurrentes_table` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre_recurrente` text NOT NULL,
  `id_responsable_recurrente` int(11) DEFAULT NULL,
  `createdAt` timestamp NULL DEFAULT NULL,
  `updatedAt` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `recurrentes_table`
--

LOCK TABLES `recurrentes_table` WRITE;
/*!40000 ALTER TABLE `recurrentes_table` DISABLE KEYS */;
INSERT INTO `recurrentes_table` VALUES (3,'Primera tarea recurrente semanal',6,'2016-08-01 18:30:11','2016-08-01 18:30:36',7),(4,'Tarea recurrente mensual',5,'2016-08-01 18:30:54','2016-08-01 18:31:00',30);
/*!40000 ALTER TABLE `recurrentes_table` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `usuarios_table` VALUES (5,'Enrique Salazar','enrique.salazar@gmail.com','666','123456',NULL,'2016-08-01 11:36:36'),(6,'Javier Vasquez','javier@fruandes.co','666','1234567890',NULL,'2016-07-30 15:28:16'),(7,'Jennifer Gonzalez','jennifer@fruandes.co','0','1234567890','0000-00-00 00:00:00','2016-08-01 11:37:03'),(8,'Mabel Paez','mabel@fruandes.co','1','1234567890',NULL,'2016-08-01 18:36:13'),(9,'Edisson Jaimes','edisson@fruandes.co','1','1234567890',NULL,'2016-08-01 01:32:39'),(10,'Stefanny Alcantara ','stefanny@fruandes.co',NULL,'1234567890','2016-07-28 00:32:58','2016-07-28 00:32:58'),(11,'Giovanni Porras','giovanni@fruandes.co',NULL,'1234567890','2016-07-29 01:48:48','2016-07-29 01:48:48'),(12,'Janir Ledesma','janir@fruandes.co',NULL,'1234567890','2016-07-31 20:59:33','2016-07-31 20:59:33'),(13,'Fabio Barón','fabio@fruandes.co',NULL,'1234567890','2016-07-31 22:06:41','2016-07-31 22:06:41'),(14,'Juan David Mejía','juan@fruandes.co',NULL,'1234567890','2016-08-01 00:32:18','2016-08-01 00:32:18'),(15,'Germán Betancourt ','german@fruandes.co',NULL,'1234567890','2016-08-01 00:32:44','2016-08-01 00:32:44');
...
-- Dump completed on 2016-08-03  7:43:52
